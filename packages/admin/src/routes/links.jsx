...
export const stateSearch = baseLink + "/student/getStatesList"
export const districtSearch = baseLink + "/student/getDistrictList"       
export const blockSearch = baseLink + "/student/getBlockList"       
